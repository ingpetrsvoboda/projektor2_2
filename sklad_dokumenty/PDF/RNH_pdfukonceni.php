...
//*
    ...
    $pdfpaticka = Projektor2_PDFContext::getPaticka();
		$pdfpaticka->Odstavec("Rodina není handicap - Individuální plán účastníka - 3.část  Účastník: ".$Ucastnik->identifikator);
...
//		$titulek->Text('Lákamí vůněhulás úmyval rohlivý jednovod lek lák hane bývá přehliv smeti. Smělý Umyslemi dopicí sudba rojskočár ří bý autný tlínům z zavěď. Umí jít A hafan bý obal stako tak úmyvatkov Buben muto. ');
	...
	$poznKUkonceni1a = new Projektor2_PDF_Blok;
		$poznKUkonceni1a->Odstavec("a. tato doba je 6 měsíců");
    ...
    $poznKUkonceni2b = new Projektor2_PDF_Blok;
		$poznKUkonceni2b->Odstavec("b. výpovědí dohody o účasti v projektu klientem z jiného důvodu než nástupu do zaměstnání (ukončení bude v den předcházející dni vzniku důvodu ukončení)");
    ...
    $poznKUkonceni3b = new Projektor2_PDF_Blok;
		$poznKUkonceni3b->Odstavec("b. ve výjimečných případech na základě podnětu vysílajícího ÚP, např. při sankčním vyřazení z evidence ÚP (ukončení bude v pracovní den předcházející dni vzniku důvodu ukončení)");
	...
	$poznamkaOsvedceni = new Projektor2_PDF_Blok;
		$poznamkaOsvedceni->Odstavec("Po ukončení účasti klienta v projektu řádným způsobem nebo z důvodu nástupu do zaměstnání po absolvování alespoň 3 aktivit projektu získá účastník Osvědčení o absolvování projektu Rodina není handicap.");
