...
//*
    $pdfhlavicka = Projektor2_PDFContext::getHlavicka();
		$pdfhlavicka->Odstavec("Individuální plán účastníka 2.část");
    ...
    $pdfpaticka = Projektor2_PDFContext::getPaticka();
		$pdfpaticka->Odstavec("Rodina není handicap - Individuální plán účastníka - 2.část  Účastník: ".$Ucastnik->identifikator);
	...
	$kurzZZTP = new Projektor2_PDF_SadaBunek();
	...
	$komunikacniKurz = new Projektor2_PDF_SadaBunek();
	...
	$motivacniProgram = new Projektor2_PDF_SadaBunek();
	...
	$pc1Kurz = new Projektor2_PDF_SadaBunek();
        $pc1Kurz->Nadpis("PC kurz");
                //$pc1Kurz->Spoust("-", $pole_pro_zobrazeni['pc1_pdf_kod_kurzu']);
        ...
        $pc2Kurz = new Projektor2_PDF_SadaBunek();
        $pc2Kurz->Nadpis("PC kurz - další");
                //$pc2Kurz->Spoust("-", $pole_pro_zobrazeni['pc2_pdf_kod_kurzu']);
	...
	$bilancDiag = new Projektor2_PDF_SadaBunek();
        ...
        $pracDiag = new Projektor2_PDF_SadaBunek();
    ...
    $prax = new Projektor2_PDF_SadaBunek();
    ...
    $prof1Kurz = new Projektor2_PDF_SadaBunek();
    ...
    $prof2Kurz = new Projektor2_PDF_SadaBunek();
    ...
    $prof3Kurz = new Projektor2_PDF_SadaBunek();
