...
//*
    $pdfhlavicka = Projektor2_PDFContext::getHlavicka();
		$pdfhlavicka->Odstavec("Individuální plán účastníka - 1. část");
	...
	$pdfpaticka = Projektor2_PDFContext::getPaticka();
		$pdfpaticka->Odstavec("Rodina není handicap - Individuální plán účastníka - 1. část  Účastník: ".$Ucastnik->identifikator);
...
//		$titulek->Text('Lákamí vůněhulás úmyval rohlivý jednovod lek lák hane bývá přehliv smeti. Smělý Umyslemi dopicí sudba rojskočár ří bý autný tlínům z zavěď. Umí jít A hafan bý obal stako tak úmyvatkov Buben muto. ');
    ...
    $bydliste = new Projektor2_PDF_SadaBunek();
    ...
    $bydlistePrechodne = new Projektor2_PDF_SadaBunek();
                $adresapole="";
                if (@$pdfpole["ulice2"]) {
    ...
    $vzdelaniSkolaII = new Projektor2_PDF_SadaBunek();
    ...
    $vzdelaniSkolaIII = new Projektor2_PDF_SadaBunek();
    ...
    $vzdelaniSkolaIV = new Projektor2_PDF_SadaBunek();
    ...
    $vzdelaniSkolaV = new Projektor2_PDF_SadaBunek();
    ...
    $vzdelaniSkoleniII = new Projektor2_PDF_SadaBunek();
    ...
    $vzdelaniSkoleniIII = new Projektor2_PDF_SadaBunek();
    ...
    $vzdelaniSkoleniIV = new Projektor2_PDF_SadaBunek();
    ...
    $vzdelaniSkoleniV = new Projektor2_PDF_SadaBunek();
    ...
    $specializaceVPraxi = new Projektor2_PDF_Blok();
                ...
                $specializaceVPraxi->Odstavec(@$pdfpole["specializace_v_praxi"]);
                //$specializaceVPraxi->VyskaPismaTextu(10);


    $jazykoveZnalosti = new Projektor2_PDF_Blok();
                $jazykoveZnalosti ->Nadpis("Jazykové znalosti");
                $jazykoveZnalosti ->VyskaPismaNadpisu(12);
    $jazykoveZnalostiAj = new Projektor2_PDF_SadaBunek();
    ...
    $jazykoveZnalostiNj = new Projektor2_PDF_SadaBunek();
    ...
    $jazykoveZnalostiRj = new Projektor2_PDF_SadaBunek();
    ...
    $jazykoveZnalostiD1 = new Projektor2_PDF_SadaBunek();
    ...
    $jazykoveZnalostiD2 = new Projektor2_PDF_SadaBunek();
    ...
    $predchoziZamestnaniI = new Projektor2_PDF_SadaBunek();
    ...
    $predchoziZamestnaniII = new Projektor2_PDF_SadaBunek();
    ...
    $predchoziZamestnaniIII = new Projektor2_PDF_SadaBunek();
    ...
    $predchoziZamestnaniIV = new Projektor2_PDF_SadaBunek();
    ...
    $predchoziZamestnaniV = new Projektor2_PDF_SadaBunek();
    ...
    $posledniPomer = new Projektor2_PDF_SadaBunek();
    ...
    $predstavaUplatneni = new Projektor2_PDF_Blok();
                $predstavaUplatneni->Nadpis("Představa o uplatnění");
                $predstavaUplatneni->VyskaPismaNadpisu(12);
    $predstavaUplatneniPopis = new Projektor2_PDF_SadaBunek();
    ...
    $predstavaUplatneniHledaOdmita = new Projektor2_PDF_SadaBunek();
    ...
    $predstavaUplatneniPozadavky = new Projektor2_PDF_SadaBunek();
    ...
    $doplnujiciUdaje = new Projektor2_PDF_Blok;
    ...
    $doplnujiciUdaje1 = new Projektor2_PDF_SadaBunek();
...
*/
   ...
   //*******************************************************************
	...
	$pdf->Ln(5);
        ...
        $pdf->Ln(5);
        $pdf->TiskniBlok($vzdelaniSkoleni);
        ...
        $pdf->Ln(5);
        $pdf->TiskniBlok($specializaceVPraxi);

        $pdf->Ln(5);
        $pdf->TiskniBlok($jazykoveZnalosti);
        ...
        $pdf->Ln(5);
        $pdf->TiskniBlok($predchoziZamestnani,5);
        ...
        $pdf->Ln(5);
        $pdf->TiskniBlok($predstavaUplatneni,5);
        ...
        $pdf->Ln(5);
        $pdf->TiskniBlok($doplnujiciUdaje,5);
...
$filepathprefix= iconv('UTF-8', 'windows-1250', "./doku/RNH IP 1.cast ");
