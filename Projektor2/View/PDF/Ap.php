...
* @author pes2704
*/
abstract class Projektor2_View_PDF_Ap extends Projektor2_View_PDF_Base{
    
    protected function setHeaderFooter($textPaticky=NULL) {
        parent::setHeaderFooter("./img/loga/loga_AP_BW.png", $textPaticky);
    }
    ...
    protected function tiskniOsobniUdaje() {
        ...
        $osobniUdaje->PridejBunku("identifikační značka účastníka: ", @$this->context["znacka"],1);        
