...
* @author pes2704
*/
class Projektor2_View_PDF_HelpPlanIP2 extends Projektor2_View_PDF_Help{
    const FILE_NAME_PREFIX = "HELP_IP_cast2 ";
    ...
    public function createPDFObject() {
        ...
        //**********************************************
        $textPaticky = "Individuální plán účastníka v projektu „Help 50+“ - část 2 ".self::FILE_NAME_PREFIX. @$this->context["identifikator"].
        ...
        //********************************************** 
        $textNadpisu1 = "INDIVIDUÁLNÍ PLÁN ÚČASTNÍKA - část 2";
