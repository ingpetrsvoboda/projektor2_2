...
class Projektor2_View_HTML_Help_Souhlas extends Projektor2_View_HTML_FormularPHP4 {
    ...
    echo '<form method="POST" action="index.php?akce=form&form=he_souhlas_uc" name="form_ukonc">';
...
<p>Datum vytvoření:
<input ID="datum_vytvor_smlouvy" type="text" name="datum_vytvor_smlouvy" size="8" maxlength="10"  readonly value="<?php
