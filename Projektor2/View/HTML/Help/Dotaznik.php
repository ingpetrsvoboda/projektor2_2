...
class Projektor2_View_HTML_Help_Dotaznik extends Projektor2_View_HTML_FormularPHP4 {
    ...
    echo '<form method="POST" action="index.php?akce=form&form=he_reg_dot" name="form_ukonc">';
...
<p>Datum vytvoření:
<input ID="datum_vytvor_dotazniku" type="text" name="datum_vytvor_dotazniku" size="20" maxlength="25" value="<?php
