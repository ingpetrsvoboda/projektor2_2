...
class Projektor2_View_HTML_Agp_Souhlas extends Projektor2_View_HTML_FormularPHP4 {
    ...
    echo '<form method="POST" action="index.php?akce=form&form=agp_souhlas_uc" name="form">';
...
<FIELDSET><LEGEND style="color:white;"><b>Osobní údaje</b></LEGEND>
  ...
  Jméno: <input ID="jmeno" type="text" name="jmeno" size="20" maxlength="50" readonly value="<?php echo @$pole['jmeno'];?>">
  Příjmení: <input ID="prijmeni" type="text" name="prijmeni" size="20" maxlength="50" readonly value="<?php echo @$pole['prijmeni'];?>">
  ...
  <p>Datum narození: <input ID="datum_narozeni" type="date" name="datum_narozeni" size="8" maxlength="10" readonly value="<?php echo @$pole['datum_narozeni'];?>">
    Rodné číslo: <input ID="rodne_cislo" type="text" name="rodne_cislo" size="20" maxlength="50" readonly value="<?php echo @$pole['rodne_cislo'];?>"></p>
  <p></p>  
</FIELDSET>  
...
<FIELDSET><LEGEND style="color:white;"><b>Bydliště a kontaktní údaje</b></LEGEND>
  ...
  <p>Město: <input ID="mesto" type="text" name="mesto" size="20" maxlength="50" readonly value="<?php echo @$pole['mesto'];?>">
  Ulice: <input ID="ulice" type="text" name="ulice" size="20" maxlength="50" readonly value="<?php echo @$pole['ulice'];?>">
  ...
  <p>Město: <input ID="mesto2" type="text" name="mesto2" size="20" maxlength="50" readonly value="<?php echo @$pole['mesto2'];?>">
  Ulice: <input ID="ulice2" type="text" name="ulice2" size="20" maxlength="50"  readonly value="<?php echo @$pole['ulice2'];?>">
  ...
  Popis: <input ID="popis_telefon" type="text" name="popis_telefon" size="40" maxlength="100" readonly value="<?php echo @$pole['popis_telefon'];?>"></p>
  <p>e-mail: <input ID="mail" type="text" name="mail" size="40" readonly value="<?php echo @$pole['mail'];?>"></p>
</FIELDSET>
...
<p>Datum vytvoření:
<input ID="datum_vytvor_smlouvy" type="date" name="datum_vytvor_smlouvy" size="8" maxlength="10"  readonly value="<?php
