 ...
 * @author pes2704
 */
class Projektor2_View_HTML_Ap_IPPoradenstvi extends Projektor2_View_HTML_FormularPHP4 {
    /**
    ...
    public function display() {
        ...
        foreach ($aktivity as $druh=>$aktivita) {
            if ($aktivita['typ']=='poradenstvi') {
                ...
                echo Projektor2_View_HTML_PlanFieldset::renderFieldsetPoradenstvi($this->context, 'zaPlanPoradnestvi->id_s_kurz_FK', $this->context['poradenstvi_'.$druh], 'id', $aktivita['nadpis'], FALSE, $aktivita['s_certifikatem']);
            }
        }        
