 ...
 * @author pes2704
 */
class Projektor2_Controller_Formular_Ap_Souhlas extends Projektor2_Controller_Formular_Ap_Menus {
    ...
    protected function getResultFormular() {
        ...
        $view = new Projektor2_View_HTML_Ap_Souhlas($pole);
    ...
    protected function getResultPdf() {
        ...
        $view = new Projektor2_View_PDF_ApSouhlas($this->request->params);
