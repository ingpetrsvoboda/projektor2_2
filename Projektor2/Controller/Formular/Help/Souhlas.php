 ...
 * @author pes2704
 */
class Projektor2_Controller_Formular_Help_Souhlas extends Projektor2_Controller_Formular_Help_Menus {
    ...
    protected function getResultFormular() {
        ...
        $view = new Projektor2_View_HTML_Help_Souhlas($pole);
    ...
    protected function getResultPdf() {
        ...
        $view = new Projektor2_View_PDF_HelpSouhlas($this->request->params);
